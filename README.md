...
## กฎที่ต้องอ่านก่อนออกแบบ

กฎทั้งหมดอยู่ใน 2 ไฟล์ แยกตามว่ากำลังทำฝั่งไหน
...
ในเว็บ `<table>` จัดให้เองอยู่แล้ว แต่ **ใน Figma ต้องบังคับเอง** เพราะตารางที่นั่นคือ
auto-layout ของคอลัมน์ที่สูงอิสระกัน
...
│   └── src/
│       ├── components/ui/     # 56 components (54 shadcn + multi-select + number-input)
│       ├── hooks/             # use-mobile
│       ├── lib/utils.ts       # cn()
