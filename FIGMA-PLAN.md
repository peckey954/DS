...
**นี่คือจุดที่ Figma ต่างจากโค้ดมากที่สุด** ในเว็บ `<table>` จัดความสูงให้ทุกช่องใน
แถวเท่ากันเอง แต่ใน Figma ตารางคือ auto-layout แนวนอนของ "คอลัมน์" ซึ่งแต่ละ
คอลัมน์เป็นแท่งแนวตั้งของตัวเอง **Figma จึงปล่อยให้แต่ละคอลัมน์สูงอิสระกัน**
...
| แถวข้อมูล | **เนื้อหาสูงสุด + 8 บน + 8 ล่าง** (input 40 → แถว 56) |
...
สคริปต์ที่ใช้จัดความสูง — รันซ้ำได้ทุกครั้งที่แก้ตาราง
...
**ข้อควรรู้** ความสูงนี้ล็อกไว้ ถ้าเพิ่มข้อความจนยาวสองบรรทัดต้องสั่งจัดใหม่
