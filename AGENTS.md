...
**เขียวสดต้องคู่กับตัวอักษรสีเข้ม ไม่ใช่ขาว** เพราะสายตามนุษย์ไวต่อเขียวมากกว่า
แดงกับน้ำเงินหลายเท่า (สัมประสิทธิ์ 0.7152 เทียบกับ 0.2126 และ 0.0722) เขียวที่
"ดูสด" จึงสว่างเกินกว่าจะวางตัวอักษรขาวได้ วัดแล้ว `green-500` กับขาวได้ 2.30
Radix `green-9` กับขาวได้ 3.09 ตกทั้งคู่ ถ้าจะใช้ตัวอักษรขาวต้องกดเขียวให้เข้มจนหม่น

จึงเลือกทางกลับกัน — ใช้เขียวสด (`green-500` สว่าง / `green-400` มืด) คู่ตัวอักษร
เขียวเข้ม ได้ 5.76 กับ 8.31 เป็นวิธีเดียวกับที่ใช้กับ amber ซึ่งสว่างด้วยเหตุผลเดียวกัน
